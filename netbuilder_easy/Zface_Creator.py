...
train_data = "/mnt/ssd-data-2/caffemaker_lmdb/monitor_video/lmdb/cam_train_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "/mnt/ssd-data-2/caffemaker_lmdb/monitor_video/lmdb/cam_val_lmdb"
...
job_name = "Zfacev0.3.2_{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "VGG_SSD_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "/home/caffemaker/caffe/models/Zface/{}".format(job_name)
...
min_dim = 500
mbox_source_layers = ['conv3_3', 'conv4_3', 'fc7', 'conv6_2', 'conv7_2']
# in percent %
min_ratio = 2
max_ratio = 30
